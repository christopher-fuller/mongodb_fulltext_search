...
The indexes are maintained automatically via the +before_save+ and +before_destroy+ callbacks on models, however you MUST run the rake task to rebuild the indexes any time your models change.
