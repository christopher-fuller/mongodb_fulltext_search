...
Words that are blacklisted from the indexes are called +stop_words+. Stop words can be specified in a YAML config file.

A config file can be generated with a default set of stop words with:
